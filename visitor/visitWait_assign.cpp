...
namespace mavka::parser {
  std::any MavkaASTVisitor::visitWait_assign(
    ...
    //    any_to_ast_value(visitAssign(context->wa_assign)); if
    ...
    //      new_assign_simple_node->start_column =
    //      assign_simple_node->start_column; new_assign_simple_node->end_line =
    //      assign_simple_node->end_line; new_assign_simple_node->end_column =
    //      assign_simple_node->end_column; const auto wait_node = new
    //      ast::WaitNode(); wait_node->start_line =
    //      assign_simple_node->start_line; wait_node->start_column =
    //      assign_simple_node->start_column; wait_node->end_line =
    //      assign_simple_node->end_line; wait_node->end_column =
    //      assign_simple_node->end_column; wait_node->value =
    //      assign_simple_node->value; new_assign_simple_node->op =
    //      assign_simple_node->op; new_assign_simple_node->name =
    //      assign_simple_node->name; new_assign_simple_node->value =
    ...
    //      new_assign_by_identifier_node->left =
    ...
    //      ast::make_ast_some(wait_node); return
    //      (ast::make_ast_some(new_assign_by_identifier_node));
    //    }
    //    if (assign_node->AssignByElementNode) {
    //      const auto assign_by_element_node =
    //      assign_node->AssignByElementNode; const auto
    //      new_assign_by_element_node = new ast::AssignByElementNode();
    ...
    //      new_assign_by_element_node->end_line =
    //      assign_by_element_node->end_line;
    ...
    //      new_assign_by_element_node->element =
    //      assign_by_element_node->element; new_assign_by_element_node->value =
    //      ast::make_ast_some(wait_node); return
    //      (ast::make_ast_some(new_assign_by_element_node));
    //    }
