...
KWID: QUOTE (KW_END | KW_DIIA | KW_STRUCTURE | KW_FOR | KW_IF | KW_WAIT | KW_TAKE | KW_GIVE | KW_AS | KW_TA | KW_IS | KW_SPEC | KW_RETURN | KW_ASYNC | KW_SUBJECT | KW_AND | KW_OR | KW_TRY | KW_CATCH | KW_ELSE | KW_THROW | KW_WHILE | KW_MODULE | KW_EQ_WORD | KW_GR_WORD | KW_SM_WORD | KW_HAS_IS_WORD | KW_MOCKUP | KW_NOT | KW_PARENT | KW_TSE);
