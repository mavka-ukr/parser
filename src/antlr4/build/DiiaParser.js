...
const serializedATN = [4,1,101,726,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,
...
0,348,349,5,15,0,0,349,350,5,99,0,0,350,351,5,17,0,0,351,359,3,70,35,0,352,
353,5,13,0,0,353,356,5,99,0,0,354,355,5,17,0,0,355,357,3,70,35,0,356,354,
...
0,0,373,39,1,0,0,0,374,375,6,20,-1,0,375,415,5,92,0,0,376,415,5,99,0,0,377,
...
0,0,0,489,487,1,0,0,0,490,493,3,110,55,0,491,494,3,70,35,0,492,494,5,99,
...
678,5,99,0,0,676,678,3,70,35,0,677,674,1,0,0,0,677,675,1,0,0,0,677,676,1,
...
export default class DiiaParser extends antlr4.Parser {
	...
	each() {
	    ...
	    try {
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        if((((_la) & ~0x1f) == 0 && ((1 << _la) & 211294236) !== 0) || ((((_la - 41)) & ~0x1f) == 0 && ((1 << (_la - 41)) & 2147486661) !== 0) || ((((_la - 73)) & ~0x1f) == 0 && ((1 << (_la - 73)) & 67895393) !== 0)) {
	            this.state = 292;
